...
export const factory = createSketch<Controls>(
  ({
    ...
    const widthData = createMemo({
      ...
      deps: [getTrackedParam("RESOLUTION"), getTrackedParam("W_DISPERSION")],
    });
